...
const deploymentName =
  config.CONVEX_DEPLOYMENT.split(":").slice(-1)[0] ?? "agile-donkey-972";

const variables = JSON.stringify({
  help:
    "This template includes prebuilt sign-in via Google OAuth and " +
  ...
  providers: [
    {
      ...
      help:
        ...
        "https://docs.Google.com/en/apps/oauth-apps/building-oauth-apps/creating-an-oauth-app\n\n" +
